"""
Django settings for financial_management_system project.
...
SECRET_KEY = getenv("financial_management_system")
API_KEY_AI = getenv("MISTRAL_API_KEY")
...
ROOT_URLCONF = 'financial_management_system.urls'
...
WSGI_APPLICATION = 'financial_management_system.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'USER': 'postgres',
        'PASSWORD': getenv("PASSWORD_POSTGRES"),
        'HOST': '127.0.0.1',
        'PORT': '5432'
    }
}
